...
export default class TheBill extends React.Component {
  ...
  renderVals() {
    ...
    return {
      ...
      ...this.billVals(),
      ...this.jobsVals(), ...this.dateVals(), ...this.warVals(), ...this.labelVals(), ...this.headVals(), ...this.freshVals(), againstRows: this.againstRows(),
  ...
  headVals() {
    const C = this.crude, P = this.prices, B = this.bill, D = this.data, keys = 'crudeNow dieselVerdict pricesDown warMonths aircraftWord lossBn suppBn'.split(' ');
