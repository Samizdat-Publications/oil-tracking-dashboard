  ...
  const { traces, layout } = useMemo(() => {
    ...
    return {
      ...
      layout: {
        ...
        xaxis: { gridcolor: 'rgba(212,160,18,0.04)', linecolor: 'rgba(212,160,18,0.04)', title: { text: 'End Price (USD/bbl)', font: { size: 11, color: '#4A5568' } }, tickprefix: '$' },
        yaxis: { gridcolor: 'rgba(212,160,18,0.04)', linecolor: 'rgba(212,160,18,0.04)', title: { text: 'Frequency', font: { size: 11, color: '#4A5568' } } },
        margin: { l: 60, r: 20, t: 10, b: 50 },
        hoverlabel: { bgcolor: '#0C1220', bordercolor: 'rgba(212,160,18,0.15)', font: { color: '#E8ECF4' } },
        showlegend: false,
        shapes: [{ type: 'line', x0: p5Val, x1: p5Val, y0: 0, y1: 1, yref: 'paper', line: { color: '#CC2936', width: 2, dash: 'dash' } }],
        annotations: [
          { x: p5Val, y: 0.95, yref: 'paper', text: `VaR(5%): $${p5Val.toFixed(2)}`, showarrow: true, arrowhead: 2, arrowcolor: '#CC2936', font: { size: 10, color: '#E8ECF4' }, ax: -60, ay: -20 },
