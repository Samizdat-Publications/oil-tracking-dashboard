    ...
    <div>
      <div className="signal-card rounded-lg overflow-hidden">
        <div
          ...
          onClick={toggle}
        >
          <span className="font-[family-name:var(--font-display)] text-xs tracking-[0.15em] uppercase text-text-primary">Simulation Controls</span>
          <span className="text-[11px] text-text-secondary number-display hidden sm:block">{summaryText}</span>
          <div className="flex items-center gap-2">
            <button
              className="bg-accent hover:bg-accent-hover text-background text-xs font-semibold px-4 py-1.5 transition-all font-[family-name:var(--font-mono)] tracking-wider uppercase"
              onClick={(e) => {
                e.stopPropagation();
                onRunSimulation();
              }}
        ...
        >
          <div className="border-t border-border grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 p-5">
            <div className="space-y-3">
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">Model</label>
                <Select value={params.model} onValueChange={(v) => setParams({ model: v as 'gbm' | 'jump_diffusion' })}>
                  <SelectTrigger className="h-9 rounded-none bg-surface border border-border text-text-primary text-xs px-3 focus:outline-none focus:ring-1 focus:ring-accent/30 w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">Lookback</label>
                <Select
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">Horizon</label>
                <Select
              ...
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">Seed (optional)</label>
                <input
                  type="number"
                  className="h-9 rounded-none bg-surface border border-border text-text-primary text-xs px-3 focus:outline-none focus:ring-1 focus:ring-accent/30 w-full font-[family-name:var(--font-mono)]"
                  placeholder="Random"
                  value={params.seed ?? ''}
              ...
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">Mu override</label>
                <input
                  type="number"
                  step="0.01"
                  className="h-9 rounded-none bg-surface border border-border text-text-primary text-xs px-3 focus:outline-none focus:ring-1 focus:ring-accent/30 w-full font-[family-name:var(--font-mono)]"
              ...
              <div>
                <label className="text-[10px] uppercase tracking-[0.15em] text-text-secondary mb-1.5 block font-[family-name:var(--font-display)]">Sigma override</label>
                <input
                  type="number"
                  step="0.01"
                  className="h-9 rounded-none bg-surface border border-border text-text-primary text-xs px-3 focus:outline-none focus:ring-1 focus:ring-accent/30 w-full font-[family-name:var(--font-mono)]"
